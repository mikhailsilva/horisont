...
const WINDOWS_ZIP = 'https://github.com/mikhailsilva/horisont/releases/download/native-0.3.1-2026.09.25/ITles-Windows-x64-0.3.1.zip';
const ANDROID_APK = 'https://github.com/mikhailsilva/horisont/releases/download/native-0.3.1-2026.09.25/itles-android-debug.apk';
const DOWNLOADS = [
  { os: 'Android · 0.3.1 (тестовая)', file: ANDROID_APK, note: 'Android 7+, debug-подпись. Не обновляет прежний release APK поверх установки. Не удаляйте старое приложение с несинхронизированными данными. На телефоне не проверено.' },
  { os: 'Windows · 0.3.1', file: WINDOWS_ZIP, note: 'Windows 10/11 x64: распакуйте ZIP и запустите ITles.exe. Без цифровой подписи; на реальном Windows не проверено.' },
